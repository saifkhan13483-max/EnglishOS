...
const MODULE_META: Record<number, Record<number, { name: string; days: string; description: string }>> = {
  ...
  2: {
    1: { name: 'Present Tense',       days: 'Days 1–10',  description: 'Simple and continuous present — the foundation of conversation' },
    2: { name: 'Past Tense',          days: 'Days 11–22', description: 'Simple and continuous past — regular verbs, irregular verbs, and telling stories' },
    3: { name: 'Future Tense',        days: 'Days 23–30', description: 'Will, going to, articles (a/an/the), comparatives and superlatives' },
    4: { name: 'Daily Conversations', days: 'Days 31–40', description: 'Shopping, restaurants, self-introduction, and asking for directions' },
    5: { name: 'Level 2 Gate',        days: 'Days 41–45', description: 'Pass the gate test to unlock Level 3 — Town' },
  },
  3: {
    1: { name: 'All 12 Tenses',       days: 'Days 1–12',  description: 'Complete tense system — from simple to perfect continuous, relative clauses, gerunds' },
    2: { name: '500 Core Words',      days: 'Days 13–24', description: 'Expand from 100 to 500 — emotions, health, education, technology, nature' },
    3: { name: 'Short Stories',       days: 'Days 25–33', description: 'Read and retell South Asian daily life stories in English' },
    4: { name: 'Reading Practice',    days: 'Days 34–41', description: 'Comprehension passages, main idea, who/what/where/why questions, reported speech' },
    5: { name: 'Level 3 Gate',        days: 'Days 42–45', description: 'Pass the gate test to unlock Level 4 — City' },
  },
  4: {
    1: { name: 'Writing Skills',      days: 'Days 1–10',  description: 'Linking words, essay structure, and paragraph writing techniques' },
    2: { name: 'Letter Writing',      days: 'Days 11–20', description: 'Formal letters, applications, and structured correspondence' },
    3: { name: 'Complex Sentences',   days: 'Days 21–30', description: 'Clauses, connectors, and advanced sentence structures' },
    4: { name: 'Speaking Confidence', days: 'Days 31–40', description: 'Common mistakes to avoid and speaking scripts for real situations' },
    5: { name: 'Idioms & Phrases',    days: 'Days 41–50', description: 'Top idioms and fixed expressions used in everyday English' },
    6: { name: 'Level 4 Gate',        days: 'Days 51–60', description: 'Pass the gate test to unlock Level 5 — Capital' },
  },
  5: {
    1: { name: 'Advanced Grammar',    days: 'Days 1–10',  description: 'Conditionals — Type 1, 2, 3 — real, imaginary, and impossible past' },
    2: { name: 'Passive Voice',       days: 'Days 11–20', description: 'Active vs passive — how to write and speak with academic precision' },
    3: { name: 'Idioms & Expressions',days: 'Days 21–30', description: 'Top 15 idioms and expressions that native speakers use every day' },
    4: { name: 'Phrasal Verbs',       days: 'Days 31–40', description: 'Top 20 phrasal verbs in context — the secret to natural English' },
    5: { name: 'Business English',    days: 'Days 41–50', description: 'Meetings, presentations, negotiations, and workplace communication' },
    6: { name: 'Level 5 Gate',        days: 'Days 51–60', description: 'Pass the gate test to unlock Level 6 — World Stage' },
  },
  6: {
    1: { name: 'Professional Emails', days: 'Days 1–10',  description: 'Job applications, cover letters, and formal email communication' },
    2: { name: 'Interview English',   days: 'Days 11–20', description: 'Job interviews — answering HR questions with confidence and clarity' },
    3: { name: 'Advanced Vocabulary', days: 'Days 21–30', description: 'Power words, word upgrades, and academic vocabulary for any domain' },
    4: { name: 'IELTS / Exam Prep',   days: 'Days 31–40', description: 'Graph descriptions, opinion essays, speaking cue cards, band scores' },
    5: { name: 'Accent & Delivery',   days: 'Days 41–50', description: 'Pronunciation polish, stress, intonation, and confident delivery' },
