...
const MODULE_META: Record<number, Record<number, { name: string; days: string; description: string }>> = {
  ...
  3: {
    ...
    2: { name: '500 Core Words',      days: 'Days 10–18', description: 'Expand from 100 to 500 — emotions, health, education, technology, nature' },
    3: { name: 'Short Stories',       days: 'Days 19–27', description: 'Read and retell South Asian daily life stories in English' },
    4: { name: 'Reading Practice',    days: 'Days 28–36', description: 'Comprehension passages, main idea, who/what/where/why questions' },
